...
module Tipi
# Public: Handles parsing Tipi attribute lists into a Hash of key/value
...
# Examples
#
#    attrlist = Tipi::AttributeList.new('astyle')
#
#    attrlist.parse
#    => { 0 => 'astyle' }
#
...
#    => { 'style' => 'astyle' }
#
#    attrlist = Tipi::AttributeList.new('quote, Famous Person, Famous Book (2001)')
#
