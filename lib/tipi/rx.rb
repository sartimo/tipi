...
module Tipi
  ...
  # but rather directly in the Tipi module).
  #
  ...
  #   }
  #   // end::try-catch[]
  # NOTE m flag is required for Tipi.js
  ...
  #   pass:quotes[text]
  #
  # NOTE we have to support an empty pass:[] for compatibility with Tipi.py
  ...
  # Matches an Tipi or Markdown horizontal rule or Tipi page break.
  #
  # Examples
  #
  #   ''' (horizontal rule)
  ...
  #   data:info
  #
  #   not c:/sample.tipi or c:\sample.tipi
  #
  if RUBY_ENGINE == 'opal'
