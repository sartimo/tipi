...
module Tipi
# Public: A pluggable adapter for integrating a syntax (aka code) highlighter into Tipi processing.
#
...
#
# Tipi provides several built-in adapters, including coderay, pygments, rouge, highlight.js, html-pipeline, and
