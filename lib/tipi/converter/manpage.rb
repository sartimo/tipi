...
# from Tipi.py, you should be able to achieve a very similar result
...
class Converter::ManPageConverter < Converter::Base
  ...
  def convert_document node
    unless node.attr? 'mantitle'
      raise 'tipi: ERROR: doctype must be set to manpage when using manpage backend'
    end
...
.\\" Generator: Tipi #{node.attr 'tipi-version'})]
