...
# consistent with the html5 backend from Tipi.py.
...
<meta name="viewport" content="width=device-width, initial-scale=1.0"#{slash}>)
    result << %(<meta name="generator" content="Tipi #{node.attr 'tipi-version'}"#{slash}>) unless (reproducible = node.attr? 'reproducible')
