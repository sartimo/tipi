...
module Tipi
  class << self
    # Public: Parse the Tipi source input into an Tipi::Document and
    ...
    #
    # input   - the String Tipi source filename
    # options - a String, Array or Hash of options to control processing (default: {})
    #           String and Array values are converted into a Hash.
    #           See Tipi::Document#initialize for details about options.
    #
    ...
    def convert input, options = {}
      ...
      if outfile
        ...
        if !stream_output && doc.safe < SafeMode::SECURE && (doc.attr? 'linkcss') && (doc.attr? 'copycss') &&
          ...
          if copy_tipi_stylesheet || copy_user_stylesheet || copy_syntax_hl_stylesheet
    ...
    # Public: Parse the contents of the Tipi source file into an
    # Tipi::Document and convert it to the specified backend format.
    #
    # input   - the String Tipi source filename
    # options - a String, Array or Hash of options to control processing (default: {})
    #           String and Array values are converted into a Hash.
    ...
    # Deprecated: Use {Tipi.convert} instead.
    alias render convert

    # Deprecated: Use {Tipi.convert_file} instead.
