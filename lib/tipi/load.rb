...
module Tipi
  class << self
    # Public: Parse the Tipi source input into a {Document}
    #
    ...
    #
    # input   - the Tipi source as a IO, String or Array.
    ...
    def load input, options = {}
      ...
      begin
        context = %(tipi: FAILED: #{attrs['docfile'] || '<stdin>'}: Failed to load Tipi document)
    ...
    # Public: Parse the contents of the Tipi source file into an Tipi::Document
    #
