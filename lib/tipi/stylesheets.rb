...
class Stylesheets
  ...
  # Public: Read the contents of the default Tipi stylesheet
  #
  # returns the [String] Tipi stylesheet data
  def primary_stylesheet_data
    @primary_stylesheet_data ||= (::File.read (::File.join STYLESHEETS_DIR, 'tipi-default.css'), mode: FILE_READ_MODE).rstrip
  end
