...
module Tipi
# Internal: Methods to parse lines of Tipi into an object hierarchy
...
# Examples
#
#   # Create a Reader for the Tipi lines and retrieve the next block from it.
...
class Parser
  ...
  # Public: Parses Tipi source read from the Reader into the Document
  #
  ...
  # Public: Parses the document header of the Tipi source read from the Reader
  #
  # Reads the Tipi source from the Reader until the end of the document
  ...
  def self.parse_document_header reader, document, header_only = false
    ...
    # yep, document title logic in Tipi is just insanity
  ...
  # Public: Parses the manpage header of the Tipi source read from the Reader
  #
  # returns Nothing
  ...
  #
  # Regular expressions from the Tipi module are used to match block
    ...
    if (list_type = list_block.context) == :dlist
      ...
      when :olist
        ...
        if ordinal == 0 && !style
          ...
          # basing style on marker level is compliant with Tipi.py
  ...
  #
  # table_reader - a Reader containing the source lines of an Tipi table
  # parent       - the parent Block of this Tipi::Table
  # attributes   - attributes captured from above this Block
  #
  # returns an instance of Tipi::Table parsed from the provided reader
  ...
  #
  # Returns a String with the legal Tipi attribute name.
  #
  # Examples
  #
