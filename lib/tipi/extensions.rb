...
(require 'tipi' unless defined? Tipi.load) unless RUBY_ENGINE == 'opal'

module Tipi
# Extensions provide a way to participate in the parsing and converting
# phases of the Tipi processor or extend the Tipi syntax.
#
# The various extensions participate in Tipi processing as follows:
#
...
module Extensions
  ...
  #
  # Prior to invoking the preprocessor, Tipi splits the source text into
  ...
  #
  # Tipi passes the document and the document's Reader to the
  ...
  #
  # Tipi invokes the {Processor#process} method on an instance of each
  ...
  #
  # Tipi passes a reference to the converted String to the {Processor#process}
  ...
  #
  # When Tipi comes across a `include::<target>[]` directive in the
  ...
  #
  # When Tipi encounters a delimited block or paragraph with an
  ...
  class Registry
    # Public: Returns the {Tipi::Document} on which the extensions in this registry are being used.
    ...
    #
    # document - the {Tipi::Document} on which the extensions are to be used.
    #
    ...
    # the Tipi source before parsing begins.
    #
    ...
    # the Tipi source after parsing is complete.
    #
    ...
    # Tipi source annotated with the specified block name (i.e., style).
    #
    ...
    # to a Symbol) of the Tipi block content (i.e., delimited block or
    ...
    # (coersed to a Symbol) of the Tipi block macro that this processor is
    ...
    def add_document_processor kind, args, &block
      ...
      kind_java_class = (defined? ::TipiJ) ? (::TipiJ::Extensions.const_get kind_class_symbol, false) : nil
  ...
  class << self
    ...
    # Examples
    #
    #   Tipi::Extensions.register UmlExtensions
    #
    #   Tipi::Extensions.register :uml, UmlExtensions
    #
    #   Tipi::Extensions.register do
    #     block_processor :plantuml, PlantUmlBlock
    #   end
    #
    #   Tipi::Extensions.register :uml do
    #     block_processor :plantuml, PlantUmlBlock
    #   end
    #
