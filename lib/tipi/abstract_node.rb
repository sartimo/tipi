...
# node of Tipi content. The state and methods on this class are common to
# all content segments in an Tipi document.
class AbstractNode
  include Logging
  ...
  # Public: Get the Tipi::Document to which this node belongs
  ...
  # Public: Get the Tipi::Converter instance being used to convert the
  # current Tipi::Document.
  def converter
    @document.converter
  end
  ...
  # matching it against the Tipi::UriSniffRx regex.
  #
  # In use by Tipi PDF
  #
