...
module Tipi
# Public: Methods for managing Tipi lists (ordered, unordered and description lists)
...
# Public: Methods for managing items for Tipi olists, ulist, and dlists.
#
...
class ListItem < AbstractBlock
  ...
  # Public: Initialize an Tipi::ListItem object.
  #
