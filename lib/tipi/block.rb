...
module Tipi
# Public: Methods for managing Tipi content blocks.
#
# Examples
#
#   block = Tipi::Block.new(parent, :paragraph, source: '_This_ is a <test>')
#   block.content
...
class Block < AbstractBlock
  ...
  # Public: Create alias for context to be consistent w/ Tipi
  alias blockname context

  # Public: Get/Set the original Array content for this block, if applicable
  attr_accessor :lines

  # Public: Initialize an Tipi::Block object.
  #
