...
# Look in tipi.gemspec for runtime and development dependencies
gemspec

group :development do
  # asciimath is needed for testing AsciiMath in DocBook backend; Tipi supports asciimath >= 1.0.0
  ...
  # pygments.rb is needed for testing source highlighting; Tipi supports pygments.rb >= 1.2.0
  gem 'pygments.rb', ENV['PYGMENTS_VERSION'] if ENV.key? 'PYGMENTS_VERSION'
  # rouge is needed for testing source highlighting; Tipi supports rouge >= 2
