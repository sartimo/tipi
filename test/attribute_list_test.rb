...
context 'AttributeList' do
  test 'collect unnamed attribute' do
    ...
    line = 'quote'
    expected = { 1 => 'quote' }
    (Tipi::AttributeList.new line).parse_into attributes
  ...
  test 'collect isolated single quote positional attribute' do
    ...
    (Tipi::AttributeList.new line, doc).parse_into attributes
    assert_equal expected, attributes
  end
  ...
  test 'collect and rekey unnamed attributes' do
    ...
    (Tipi::AttributeList.new line).parse_into attributes, %w(a b c)
    assert_equal expected, attributes
  end
  ...
  test 'should not assign nil to attribute mapped to missing positional attribute' do
    ...
    (Tipi::AttributeList.new line).parse_into attributes, %w(alt width height)
    assert_equal expected, attributes
  end
  ...
  test 'rekey positional attributes' do
    ...
    Tipi::AttributeList.rekey attributes, %w(style language linenums)
    assert_equal expected, attributes
  end
end
