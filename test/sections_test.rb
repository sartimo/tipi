...
context 'Sections' do
  context 'Ids' do
    ...
    test 'can set start index of synthetic ids' do
      old_unique_id_start_index = Tipi::Compliance.unique_id_start_index
      begin
        input = <<~'EOS'
        == Some section
        ...
        text
        EOS
        Tipi::Compliance.unique_id_start_index = 1
        doc = document_from_string input
        assert_equal '_some_section', doc.blocks[0].id
        assert_equal '_some_section_1', doc.blocks[1].id
      ensure
        Tipi::Compliance.unique_id_start_index = old_unique_id_start_index
      end
    end
  ...
  context 'Levels' do
    context 'Document Title (Level 0)' do
      ...
      test 'document title with multiline syntax and unicode characters' do
        ...
        assert_xpath '//h1[text()="Tipi Writer’s Guide"]', result, 1
      end
    ...
    context 'Level 1' do
      ...
      test 'with multibyte characters' do
        input = '== Tipi in 中文'
        output = convert_string input
        assert_xpath '//h2[@id="_tipi_in_中文"][text()="Tipi in 中文"]', output
      end
  ...
  context 'Discrete Heading' do
    ...
    test 'discrete heading should be a block with context floating_title' do
      ...
      assert_kind_of Tipi::Block, heading
  ...
  context 'Section Numbering' do
    test 'should create section number with one entry for level 1' do
      doc = empty_document
      sect1 = Tipi::Section.new nil, nil, true
      doc << sect1
    ...
    test 'should create section number with two entries for level 2' do
      ...
      sect1 = Tipi::Section.new nil, nil, true
      doc << sect1
      sect1_1 = Tipi::Section.new sect1, nil, true
      sect1 << sect1_1
    ...
    test 'should create section number with three entries for level 3' do
      ...
      sect1_1 = Tipi::Section.new sect1, nil, true
      sect1 << sect1_1
      sect1_1_1 = Tipi::Section.new sect1_1, nil, true
      sect1_1 << sect1_1_1
    ...
    test 'should create section number for second section in level' do
      ...
      sect1_1 = Tipi::Section.new sect1, nil, true
      sect1 << sect1_1
      sect1_2 = Tipi::Section.new sect1, nil, true
      sect1 << sect1_2
    ...
    # NOTE Tipi.py fails this test because it does not properly check for a None value when looking up the numbered attribute
    ...
    test 'table with tipi content should not disable numbering of subsequent sections' do
      input = <<~'EOS'
      = Document Title
      :numbered:
    ...
    test 'reindex_sections should correct section enumeration after sections are modified' do
      ...
      doc = document_from_string input
      second_section = Tipi::Section.new doc, nil, true
  ...
  context 'Special sections' do
    ...
    test 'should allow a special section to be nested at arbitrary depth in DocBook output' do
      ...
      Glossaries entries are an example of a style of Tipi description lists.
